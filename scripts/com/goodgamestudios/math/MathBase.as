package com.goodgamestudios.math
{
   public class MathBase
   {
      ...
      public static function random(param1:Number, param2:Number, param3:Boolean = true) : Number
      {
         if(param3)
         {
      ...
      public static function proportion(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number = 1) : Number
      {
         ...
         var _loc7_:Number = (param4 - param3) / (param2 - param1);
         return _loc7_ * (_loc6_ - param1) + param3;
      }
