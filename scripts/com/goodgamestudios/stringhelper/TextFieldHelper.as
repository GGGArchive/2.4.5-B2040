package com.goodgamestudios.stringhelper
{
   ...
   public class TextFieldHelper
   {
      ...
      public static function recolorTextField(param1:TextField, param2:uint) : void
      {
      ...
      public static function changeTextFromatSizeByTextWidth(param1:Object, param2:TextField, param3:String, param4:int = 1) : void
      {
         ...
         param2.text = param3;
         var _loc5_:TextFormat = param2.defaultTextFormat;
         _loc5_.size = param1;
      ...
      public static function changeVerticalAlignInMultiLineTextfield(param1:TextField) : void
      {
         ...
         var _loc4_:Number = param1.height - (param1.textHeight + Number(_loc3_.leading));
         if(_loc4_ < 0)
         {
            return;
         }
      ...
      public static function sliceTextAnAddPoints(param1:TextField) : void
      {
         var _loc5_:Array = null;
         var _loc6_:String = null;
         var _loc7_:String = null;
         var _loc2_:String = "...";
         var _loc3_:Number = param1.textWidth;
         var _loc4_:Number = param1.width - 4;
         if(_loc3_ > _loc4_)
         {
            _loc5_ = param1.text.split(" ");
            _loc6_ = "";
            param1.text = "";
            for each(_loc7_ in _loc5_)
            {
               param1.appendText(_loc7_ + " " + _loc2_);
               if(param1.textWidth < _loc4_)
               {
                  _loc6_ = _loc6_ + (_loc7_ + " ");
                  param1.text = param1.text.slice(0,param1.text.indexOf(_loc2_));
                  continue;
               }
               break;
            }
      ...
      private static function onTextInput(param1:TextEvent) : void
      {
         ...
         {
            _loc4_ = _loc4_ + _loc2_[0].segments.pop();
         }
      ...
      private static function calcBiDiDisplay(param1:String, param2:String, param3:Number, param4:String = "rtl", param5:int = 1) : Array
      {
         ...
         {
            _loc7_ = param1.charCodeAt(_loc10_);
            if(_loc7_ == 32 || _loc7_ == 10 || _loc7_ == 12 || _loc7_ == 13)
            {
               _loc9_ = _loc9_ + "N";
            }
         ...
         while(_loc10_ < param1.length)
         {
            ...
            {
               _loc13_ = _loc13_ + param1.charAt(_loc10_);
               _loc14_ = _loc14_ + _loc8_.charAt(_loc10_);
            }
            _loc10_++;
         }
         if(_loc13_ != "")
         ...
         _loc12_ = _loc11_[0].type;
         var _loc20_:Number = _loc12_ == "L"?Number(0):Number(1);
         ...
         {
            _loc24_ = _loc6_[_loc10_];
            _loc24_.segments = new Array();
            ...
            while(_loc7_ < _loc24_.length)
            {
               ...
               {
                  _loc26_ = _loc26_ + _loc24_[_loc7_].text;
                  _loc27_ = _loc27_ + _loc24_[_loc7_].format;
               }
      ...
      {
         param1 = param1.split(param2).join(param3);
         return param1;
      }
      ...
      public static function changeFormat(param1:TextField, param2:Object) : void
      {
         var _loc3_:TextFormat = param1.getTextFormat();
         _loc3_.size = param2;
         param1.setTextFormat(_loc3_);
