package com.goodgamestudios.basic.view
{
   ...
   import com.goodgamestudios.signal.BooleanSignal;
   ...
   public class BasicComboboxComponent
   {
      ...
      public var userClickItemSignal:BooleanSignal;
      
      private var selectionChanged:Boolean;
      
      public function BasicComboboxComponent(param1:MovieClip, param2:Class, param3:String = "", param4:int = 1, param5:int = 30, param6:int = 28, param7:int = 0, param8:Boolean = false)
      {
         var _loc9_:TextFormat = null;
         this.userClickItemSignal = new BooleanSignal();
         super();
         this._disp = param1;
         this._itemClass = param2;
         this._itemDir = param4;
         this.CLOSED_HEIGHT = param5;
         this.ITEM_HEIGHT = param6;
         this.ITEM_WIDTH = param7;
         ...
         if(this.ITEM_WIDTH > 0)
         {
            ...
            _loc9_ = this._disp.txt_selected.getTextFormat() as TextFormat;
            if(_loc9_.align == TextFormatAlign.LEFT)
            {
               this._disp.txt_selected.width = this.ITEM_WIDTH;
            }
         }
         ...
         {
            this.assignLabel(this._disp.txt_selected,this._defaultString);
         }
      }
      ...
      protected function fillItems() : void
      {
         ...
         if(this._itemData.length > 1)
         {
            ...
            {
               _loc3_ = new this.itemClass() as MovieClip;
               _loc3_.mouseChildren = false;
               this.assignLabel(_loc3_.txt_item,this._itemData[_loc2_].label);
               if(this.ITEM_WIDTH > 0)
               {
                  _loc3_.bg.width = this.ITEM_WIDTH;
                  _loc3_.txt_item.width = this.ITEM_WIDTH;
               }
      ...
      public function addItem(param1:Object) : void
      {
         ...
         if(this._itemDir == 1)
         {
            _loc2_ = _loc2_ + (this._disp.item_Holder.y - (this._disp.txt_selected.y + this._disp.txt_selected.height));
         }
         this._scaleOpen = _loc2_ / this.CLOSED_HEIGHT;
         var _loc3_:MovieClip = new this.itemClass() as MovieClip;
         _loc3_.mouseChildren = false;
         this.assignLabel(_loc3_.txt_item,param1.label);
         if(this.ITEM_WIDTH > 0)
         {
            _loc3_.bg.width = this.ITEM_WIDTH;
            _loc3_.txt_item.width = this.ITEM_WIDTH;
      ...
      protected function assignLabel(param1:TextField, param2:String) : void
      {
         param1.text = param2;
      }
      ...
      public function selectItemIndex(param1:int) : void
      {
         ...
         this.selectionChanged = this._selectedItem != param1;
         ...
         else
         {
            ...
            this.assignLabel(this._disp.txt_selected,this._itemData[this._selectedItem].label);
         }
      ...
      private function dispatchUserClickItem() : void
      {
