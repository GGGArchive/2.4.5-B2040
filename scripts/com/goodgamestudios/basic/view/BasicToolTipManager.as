package com.goodgamestudios.basic.view
{
   ...
   public class BasicToolTipManager
   {
      ...
      public function BasicToolTipManager(param1:Sprite, param2:Class, param3:Class)
      {
         super();
         ...
         this._tooltipBody = new param2();
         this._tooltipArrow = new param3();
         ...
         this.languageFontmanager.addEventListener(LanguageDataEvent.FONT_LOAD_COMPLETE,this.onFontsLoaded);
      }
      ...
      public function destroy() : void
      {
         ...
         this.languageFontmanager.removeEventListener(LanguageDataEvent.FONT_LOAD_COMPLETE,this.onFontsLoaded);
      }
      ...
      public function show(param1:Object, param2:DisplayObject = null) : void
      {
         if(param1 == null)
         {
            return;
         ...
         var _loc4_:Rectangle = this._disp.getBounds(this._disp);
         var _loc5_:int = _loc4_.width * 0.5;
         var _loc6_:Point = this._target.parent.localToGlobal(new Point(this._target.x,this._target.y));
         ...
         if(_loc7_ + _loc5_ > this._disp.stage.stageWidth)
         {
            ...
            this._tooltipArrow.x = MathBase.min(int(this._background.width * 0.5 - 10),int(this._disp.globalToLocal(new Point(_loc6_.x,0)).x));
         }
         ...
         {
            _loc8_ = _loc8_ + (_loc3_.top - this.ARROW_HEIGHT - this.ARROW_OFFSET) * this._disp.scaleY;
      ...
      protected function assignToolTipText(param1:Object) : void
      {
         this._textField.text = String(param1);
      }
