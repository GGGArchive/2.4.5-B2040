package com.goodgamestudios.basic.model.components
{
   ...
   public class BasicSessionData
   {
      ...
      public function initLoggedinTime(param1:Number, param2:Number = 0) : void
      {
         if(param2 == 0)
         {
            param2 = BasicConstants.LOGGEDIN_MESSAGE_TIME_INTERVAL;
         }
      ...
      protected function onLoggedinMessageTimerComplete(param1:TimerEvent) : void
      {
         ...
         this._loggedinTime = this._loggedinTime + BasicConstants.LOGGEDIN_MESSAGE_TIME_INTERVAL;
         ...
         {
            this.showLoggedinTimeIntervalMessage(_loc2_,_loc3_);
         }
         this._loggedinTimer.start();
      }
      
      public final function showLoggedinTimeIntervalMessage(param1:String, param2:String) : void
      {
         BasicLayoutManager.getInstance().showDialog(CommonDialogNames.StandardOkDialog_NAME,new BasicStandardOkDialogProperties(param1,param2));
      }
