package com.goodgamestudios.mafia.view.dialogs
{
   ...
   public class MafiaStandardOkDialog extends MafiaDialog
   {
      
      public static const NAME:String = CommonDialogNames.StandardOkDialog_NAME;
       
      
      public function MafiaStandardOkDialog(param1:Sprite)
      {
         super(param1);
      }
      ...
      protected function get standardDialog() : MafiaStandardOk
      {
         return disp as MafiaStandardOk;
      }
   }
}
