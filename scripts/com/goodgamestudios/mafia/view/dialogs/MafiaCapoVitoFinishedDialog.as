package com.goodgamestudios.mafia.view.dialogs
{
   ...
   public class MafiaCapoVitoFinishedDialog extends MafiaDialog
   {
      
      public static const NAME:String = "MafiaCapoVitoFinishedDialog";
       
      
      public function MafiaCapoVitoFinishedDialog(param1:Sprite)
      {
         super(param1);
      }
      ...
      override protected function applyProperties() : void
      {
         ...
         this.dialog.txt_copy.text = MafiaModel.languageData.getTextById("event_capovito_copy_4");
      ...
      protected function get dialog() : EventDialog_12
      {
         return disp as EventDialog_12;
      }
   }
}
