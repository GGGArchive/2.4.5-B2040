package com.goodgamestudios.mafia.view.dialogs
{
   ...
   public class MafiaCapoVitoDialog extends MafiaDialog
   {
      
      public static const NAME:String = "MafiaCapoVitoDialog";
       
      
      public function MafiaCapoVitoDialog(param1:Sprite)
      {
         super(param1);
      }
      ...
      override public function show() : void
      {
         ...
         controller.addEventListener(MafiaSpecialEventsEvent.CAPOVITO_EVENT_DATA_UPDATED,this.onData);
         controller.addEventListener(MafiaSpecialEventsEvent.CAPOVITO_TIME_UPDATE,this.onTimeUpdate);
         controller.addEventListener(MafiaSpecialEventsEvent.SPECIAL_EVENT_IS_OVER,this.onEventEnded);
         if(MafiaModel.specialEvent.capoVitoEvent.item)
         {
            this.fillCapo(MafiaModel.specialEvent.capoVitoEvent);
         }
      }
      
      override protected function removeEvents() : void
      {
         controller.removeEventListener(MafiaSpecialEventsEvent.CAPOVITO_EVENT_DATA_UPDATED,this.onData);
         controller.removeEventListener(MafiaSpecialEventsEvent.CAPOVITO_TIME_UPDATE,this.onTimeUpdate);
      ...
      {
         this.fillCapo(param1.params[0]);
      }
      
      private function fillCapo(param1:MafiaCapoVitoEvent) : void
      {
      ...
      {
         this.dialog.txt_inTown.text = MafiaModel.languageData.getTextById("event_capovito_inTown") + "\n" + param1.params[0];
      }
      
      override protected function applyProperties() : void
      {
         super.applyProperties();
         this.dialog.txt_copy.text = MafiaModel.userData.profileData.level >= 12?MafiaModel.languageData.getTextById("event_capovito_copy_1"):MafiaModel.languageData.getTextById("event_capovito_copy_6");
      ...
      protected function get dialog() : EventDialog_11
      {
         return disp as EventDialog_11;
      }
   }
}
