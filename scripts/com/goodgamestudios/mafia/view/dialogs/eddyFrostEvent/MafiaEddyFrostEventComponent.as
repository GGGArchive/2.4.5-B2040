package com.goodgamestudios.mafia.view.dialogs.eddyFrostEvent
{
   ...
   public class MafiaEddyFrostEventComponent extends MafiaCalendarEventDialogComponent
   {
      ...
      private var nextUnlockableField:Btn_CalendarButtonEddyThumb;
      
      public function MafiaEddyFrostEventComponent(param1:DisplayObject, param2:Boolean = true)
      {
         super(param1,param2);
         sendToBackground();
      ...
      {
         var _loc2_:Btn_CalendarButtonEddyThumb = null;
         ...
         var _loc9_:int = 0;
         while(_loc9_ < MafiaEddyFrostEvent.NUMBER_OF_ENEMIES - 1)
         {
            _loc3_ = "field_" + (_loc9_ + 1);
            _loc2_ = this.calendar[_loc3_] as Btn_CalendarButtonEddyThumb;
      ...
      {
         if(param1.target is Btn_CalendarButtonEddyThumb)
         {
            this.onClickOnCalendarField(param1.target as Btn_CalendarButtonEddyThumb);
         }
         if(param1.target is Btn_CalendarButtonEddy && MafiaModel.specialEvent.eddyFrostEvent.areAllUnlocked && !MafiaModel.specialEvent.eddyFrostEvent.isBossDead)
         {
            this.gotoWanted();
         }
      ...
      private function onClickOnCalendarField(param1:Btn_CalendarButtonEddyThumb) : void
      {
         var _loc2_:MafiaEddyFrostEvent = MafiaModel.specialEvent.eddyFrostEvent;
      ...
      private function gotoWanted() : void
      {
         ...
         layoutManager.hideDialog(MafiaEddyFrostEventDialog);
      ...
      private function fillToolTip(param1:Btn_CalendarButtonEddyThumb, param2:String, param3:Boolean) : void
      {
      ...
      private function onUpdateTimedTooltipText(param1:Array) : String
      {
         ...
         var _loc4_:int = MafiaModel.specialEvent.eddyFrostEvent.timeUntilUnlockOfEnemy(_loc2_);
         var _loc5_:String = "";
         if(_loc3_)
         {
      ...
      protected function get calendar() : EventDialog_10_ComponentCalendar
      {
         return disp as EventDialog_10_ComponentCalendar;
      }
   }
}
