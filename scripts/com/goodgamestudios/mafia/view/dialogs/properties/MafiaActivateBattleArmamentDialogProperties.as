package com.goodgamestudios.mafia.view.dialogs.properties
{
   ...
   public class MafiaActivateBattleArmamentDialogProperties extends BasicProperties
   {
      ...
      public function MafiaActivateBattleArmamentDialogProperties(param1:String, param2:String, param3:Function = null, param4:Function = null, param5:String = "", param6:uint = 0)
      {
         this.title = param1;
         this.copy = param2;
