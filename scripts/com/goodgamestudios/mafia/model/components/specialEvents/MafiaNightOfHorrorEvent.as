package com.goodgamestudios.mafia.model.components.specialEvents
{
   ...
   public class MafiaNightOfHorrorEvent extends MafiaSpecialEvent
   {
       
      
      public var item:ItemVO;
      
      public function MafiaNightOfHorrorEvent()
      {
         _eventId = Constants_SpecialEvents.ID_NIGHT_OF_HORROR;
         super();
      }
      ...
      override public function update(param1:Number) : void
      {
         ...
         if(isEventActive)
         {
            BasicController.getInstance().dispatchEvent(new MafiaSpecialEventsEvent(MafiaSpecialEventsEvent.NIGHTOFHORROR_TIME_UPDATE,[runTimeString]));
         }
      }
      
      override protected function eventEnded() : void
      {
         trace("Night of Horror event ended!");
