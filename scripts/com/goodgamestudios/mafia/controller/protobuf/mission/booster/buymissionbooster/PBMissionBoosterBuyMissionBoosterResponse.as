package com.goodgamestudios.mafia.controller.protobuf.mission.booster.buymissionbooster
{
   ...
   public final class PBMissionBoosterBuyMissionBoosterResponse extends Message
   {
      
      public static const RESULT:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("com.goodgamestudios.mafia.controller.protobuf.mission.booster.buymissionbooster.Response.result","result",1 << 3 | WireType.VARINT,PBMissionBoosterBuyMissionBoosterResult);
       
      
      public var result:int;
      
      public function PBMissionBoosterBuyMissionBoosterResponse()
      {
         super();
      }
