package com.goodgamestudios.mafia.controller.protobuf.mission.start
{
   ...
   public final class PBMissionStartResponse extends Message
   {
      
      public static const RESULT:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("com.goodgamestudios.mafia.controller.protobuf.mission.start.Response.result","result",1 << 3 | WireType.VARINT,PBMissionStartResult);
      
      public static const PLAYER_STATUS:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("com.goodgamestudios.mafia.controller.protobuf.mission.start.Response.player_status","playerStatus",2 << 3 | WireType.VARINT,PBPlayerStatus);
      
      public static const PROGRESS_TIME:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("com.goodgamestudios.mafia.controller.protobuf.mission.start.Response.progress_time","progressTime",3 << 3 | WireType.VARINT);
      
      public static const REMAINING_TIME:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.goodgamestudios.mafia.controller.protobuf.mission.start.Response.remaining_time","remainingTime",4 << 3 | WireType.VARINT);
      
      public static const MISSION_GIVER:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("com.goodgamestudios.mafia.controller.protobuf.mission.start.Response.mission_giver","missionGiver",5 << 3 | WireType.VARINT);
      
      public static const MISSION_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("com.goodgamestudios.mafia.controller.protobuf.mission.start.Response.mission_id","missionId",6 << 3 | WireType.VARINT);
      ...
      public function PBMissionStartResponse()
      {
         super();
      }
