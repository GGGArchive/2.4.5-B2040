package com.goodgamestudios.mafia.controller.protobuf.specialevent.city.startcityeventfight
{
   ...
   public final class PBSpecialeventCityStartCityEventFightResponse extends Message
   {
      
      public static const RESULT:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("com.goodgamestudios.mafia.controller.protobuf.specialevent.city.startcityeventfight.Response.result","result",1 << 3 | WireType.VARINT,PBSpecialeventCityStartCityEventFightResult);
      
      public static const FIGHT:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("com.goodgamestudios.mafia.controller.protobuf.specialevent.city.startcityeventfight.Response.fight","fight",2 << 3 | WireType.LENGTH_DELIMITED,PBFight);
      
      public static const REWARD:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("com.goodgamestudios.mafia.controller.protobuf.specialevent.city.startcityeventfight.Response.reward","reward",3 << 3 | WireType.LENGTH_DELIMITED,PBReward);
      ...
      public function PBSpecialeventCityStartCityEventFightResponse()
      {
         super();
      }
