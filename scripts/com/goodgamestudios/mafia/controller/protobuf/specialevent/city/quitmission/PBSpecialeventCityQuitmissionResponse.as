package com.goodgamestudios.mafia.controller.protobuf.specialevent.city.quitmission
{
   ...
   public final class PBSpecialeventCityQuitmissionResponse extends Message
   {
      
      public static const RESULT:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("com.goodgamestudios.mafia.controller.protobuf.specialevent.city.quitmission.Response.result","result",1 << 3 | WireType.VARINT,PBSpecialeventCityQuitmissionResult);
      
      public static const FIGHT:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("com.goodgamestudios.mafia.controller.protobuf.specialevent.city.quitmission.Response.fight","fight",2 << 3 | WireType.LENGTH_DELIMITED,PBFight);
      
      public static const REWARD:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("com.goodgamestudios.mafia.controller.protobuf.specialevent.city.quitmission.Response.reward","reward",3 << 3 | WireType.LENGTH_DELIMITED,PBReward);
      ...
      public function PBSpecialeventCityQuitmissionResponse()
      {
         super();
      }
