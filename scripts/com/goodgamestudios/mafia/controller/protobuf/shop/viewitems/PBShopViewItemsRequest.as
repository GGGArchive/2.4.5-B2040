package com.goodgamestudios.mafia.controller.protobuf.shop.viewitems
{
   ...
   public final class PBShopViewItemsRequest extends Message
   {
      
      public static const SHOP:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("com.goodgamestudios.mafia.controller.protobuf.shop.viewitems.Request.shop","shop",1 << 3 | WireType.VARINT,PBShopType);
       
      
      public var shop:int;
      
      public function PBShopViewItemsRequest()
      {
         super();
      }
