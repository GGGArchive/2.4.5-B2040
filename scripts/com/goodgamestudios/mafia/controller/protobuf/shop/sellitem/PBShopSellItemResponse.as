package com.goodgamestudios.mafia.controller.protobuf.shop.sellitem
{
   ...
   public final class PBShopSellItemResponse extends Message
   {
      
      public static const RESULT:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("com.goodgamestudios.mafia.controller.protobuf.shop.sellitem.Response.result","result",1 << 3 | WireType.VARINT,PBShopSellItemResult);
      
      public static const ITEM:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("com.goodgamestudios.mafia.controller.protobuf.shop.sellitem.Response.item","item",2 << 3 | WireType.LENGTH_DELIMITED,PBItem);
      ...
      public function PBShopSellItemResponse()
      {
         this.result = PBShopSellItemResult.OK;
         super();
      }
