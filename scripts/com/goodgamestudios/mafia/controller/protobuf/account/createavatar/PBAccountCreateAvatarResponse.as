package com.goodgamestudios.mafia.controller.protobuf.account.createavatar
{
   ...
   public final class PBAccountCreateAvatarResponse extends Message
   {
      
      public static const RESULT:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("com.goodgamestudios.mafia.controller.protobuf.account.createavatar.Response.result","result",1 << 3 | WireType.VARINT,PBAccountCreateAvatarResult);
       
      
      public var result:int;
      
      public function PBAccountCreateAvatarResponse()
      {
         super();
      }
