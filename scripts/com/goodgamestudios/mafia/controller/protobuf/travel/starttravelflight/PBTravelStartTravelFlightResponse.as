package com.goodgamestudios.mafia.controller.protobuf.travel.starttravelflight
{
   ...
   public final class PBTravelStartTravelFlightResponse extends Message
   {
      
      public static const RESULT:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("com.goodgamestudios.mafia.controller.protobuf.travel.starttravelflight.Response.result","result",1 << 3 | WireType.VARINT,PBTravelStartTravelFlightResult);
       
      
      public var result:int;
      
      public function PBTravelStartTravelFlightResponse()
      {
         super();
      }
