package com.goodgamestudios.mafia.controller.protobuf.fight.selectcityfightitem
{
   ...
   public final class PBFightSelectCityFightItemResponse extends Message
   {
      
      public static const RESULT:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("com.goodgamestudios.mafia.controller.protobuf.fight.selectcityfightitem.Response.result","result",1 << 3 | WireType.VARINT,PBFightSelectCityFightItemResult);
       
      
      public var result:int;
      
      public function PBFightSelectCityFightItemResponse()
      {
         super();
      }
