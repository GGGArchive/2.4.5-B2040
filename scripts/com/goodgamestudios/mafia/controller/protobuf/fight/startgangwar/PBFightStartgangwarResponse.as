package com.goodgamestudios.mafia.controller.protobuf.fight.startgangwar
{
   ...
   public final class PBFightStartgangwarResponse extends Message
   {
      
      public static const RESULT:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("com.goodgamestudios.mafia.controller.protobuf.fight.startgangwar.Response.result","result",1 << 3 | WireType.VARINT,PBFightStartgangwarResult);
      
      public static const FIGHT:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("com.goodgamestudios.mafia.controller.protobuf.fight.startgangwar.Response.fight","fight",2 << 3 | WireType.LENGTH_DELIMITED,PBFight);
      
      public static const REWARD:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("com.goodgamestudios.mafia.controller.protobuf.fight.startgangwar.Response.reward","reward",3 << 3 | WireType.LENGTH_DELIMITED,PBReward);
      ...
      public function PBFightStartgangwarResponse()
      {
         super();
      }
