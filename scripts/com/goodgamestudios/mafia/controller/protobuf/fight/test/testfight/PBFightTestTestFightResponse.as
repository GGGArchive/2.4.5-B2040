package com.goodgamestudios.mafia.controller.protobuf.fight.test.testfight
{
   ...
   public final class PBFightTestTestFightResponse extends Message
   {
      
      public static const FIGHT:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("com.goodgamestudios.mafia.controller.protobuf.fight.test.testfight.Response.fight","fight",1 << 3 | WireType.LENGTH_DELIMITED,PBFight);
      
      public static const REWARD:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("com.goodgamestudios.mafia.controller.protobuf.fight.test.testfight.Response.reward","reward",2 << 3 | WireType.LENGTH_DELIMITED,PBReward);
      ...
      public function PBFightTestTestFightResponse()
      {
         super();
      }
