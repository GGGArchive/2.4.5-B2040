package com.goodgamestudios.mafia.controller.protobuf.family.changecrest
{
   ...
   public final class PBFamilyChangeCrestResponse extends Message
   {
      
      public static const RESULT:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("com.goodgamestudios.mafia.controller.protobuf.family.changecrest.Response.result","result",1 << 3 | WireType.VARINT,PBFamilyChangeCrestResult);
       
      
      public var result:int;
      
      public function PBFamilyChangeCrestResponse()
      {
         super();
      }
