package com.goodgamestudios.mafia.controller.protobuf.family.createfamily
{
   ...
   public final class PBFamilyCreateFamilyResponse extends Message
   {
      
      public static const RESULT:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("com.goodgamestudios.mafia.controller.protobuf.family.createfamily.Response.result","result",1 << 3 | WireType.VARINT,PBFamilyCreateFamilyResult);
       
      
      public var result:int;
      
      public function PBFamilyCreateFamilyResponse()
      {
         super();
      }
