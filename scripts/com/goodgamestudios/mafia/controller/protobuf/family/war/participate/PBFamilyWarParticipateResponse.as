package com.goodgamestudios.mafia.controller.protobuf.family.war.participate
{
   ...
   public final class PBFamilyWarParticipateResponse extends Message
   {
      
      public static const RESULT:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("com.goodgamestudios.mafia.controller.protobuf.family.war.participate.Response.result","result",1 << 3 | WireType.VARINT,PBFamilyWarParticipateResult);
       
      
      public var result:int;
      
      public function PBFamilyWarParticipateResponse()
      {
         super();
      }
