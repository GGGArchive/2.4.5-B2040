package com.goodgamestudios.mafia.controller.protobuf.family.updatefamilybooster
{
   ...
   public final class PBFamilyUpdatefamilyboosterResponse extends Message
   {
      
      public static const RESULT:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("com.goodgamestudios.mafia.controller.protobuf.family.updatefamilybooster.Response.result","result",1 << 3 | WireType.VARINT,PBFamilyUpdatefamilyboosterResult);
       
      
      public var result:int;
      
      public function PBFamilyUpdatefamilyboosterResponse()
      {
         super();
      }
