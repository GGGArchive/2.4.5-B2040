package com.goodgamestudios.mafia.controller.protobuf.family.joinfamily
{
   ...
   public final class PBFamilyJoinFamilyResponse extends Message
   {
      
      public static const RESULT:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("com.goodgamestudios.mafia.controller.protobuf.family.joinfamily.Response.result","result",1 << 3 | WireType.VARINT,PBFamilyJoinFamilyResult);
       
      
      public var result:int;
      
      public function PBFamilyJoinFamilyResponse()
      {
         super();
      }
